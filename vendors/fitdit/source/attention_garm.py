...
from source.attention_processor_garm import Attention, JointAttnProcessor2_0
...
class JointTransformerBlock(nn.Module):
    ...
    def forward(
        self, hidden_states: torch.FloatTensor, encoder_hidden_states: torch.FloatTensor, temb: torch.FloatTensor, ref_key: List, ref_value: List
    ):
