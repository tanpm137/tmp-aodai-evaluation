...
from source.attention_processor_tryon import Attention
...
class BasicTransformerBlock(nn.Module):
    ...
    def forward(
        ...
        dub_bsz,N,L=garment_features[curr_garment_feat_idx].shape
        #to b,N*num_ref,L
        reshaped_garm= garment_features[curr_garment_feat_idx].view(dub_bsz//num_ref,N*num_ref,L)
