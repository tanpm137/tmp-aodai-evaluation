...
from diffusers.configuration_utils import ConfigMixin, register_to_config,LegacyConfigMixin
from diffusers.models.embeddings import ImagePositionalEmbeddings
from diffusers.utils import USE_PEFT_BACKEND, BaseOutput, deprecate, is_torch_version,logging
from source.attentionhacked_garmnet import BasicTransformerBlock
...
class Transformer2DModel(LegacyModelMixin, LegacyConfigMixin):
    ...
    def __init__(
        ...
        self.is_last_attn_block=is_last_attn_block
        ...
        self.transformer_blocks = nn.ModuleList(
            [
                BasicTransformerBlock(
                    ...
                    is_last_attn_block=self.is_last_attn_block,
                )
    ...
    def forward(
        ...
        for block in self.transformer_blocks:
            ...
            garment_features.append(out_garment_feat)
