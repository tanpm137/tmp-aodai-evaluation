...
3. **Pretrained Models**: Download and place checkpoints in the `pretrained/` directory:
   ...
   | **FitDiT**       | `IMAGDressing-v1_512.pt`                     | [🌐 Hugging Face](https://huggingface.co/BoyuanJiang/FitDiT)                         |
   | **IMAGDressing** | `vit_ip_adapter.pth`, `vit_clip_adapter.pth` | [🌐 Hugging Face](https://huggingface.co/feishen29/IMAGDressing/tree/main)           |
